...
const file_identity_v1_identity_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\x11.identity.v1.UserR\x04user2\xa1\x04\n" +
	...
	"\x0eGetUserByEmail\x12\".identity.v1.GetUserByEmailRequest\x1a#.identity.v1.GetUserByEmailResponse\x12b\n" +
	...
	"\x0eDeactivateUser\x12\".identity.v1.DeactivateUserRequest\x1a#.identity.v1.DeactivateUserResponseB<Z:github.com/s7venking/ticket-box/gen/identity/v1;identityv1b\x06proto3"
...
var file_identity_v1_identity_proto_goTypes = []any{
	...
	(*UpdateUserProfileRequest)(nil),  // 7: identity.v1.UpdateUserProfileRequest
	(*UpdateUserProfileResponse)(nil), // 8: identity.v1.UpdateUserProfileResponse
	(*ActivateUserRequest)(nil),       // 9: identity.v1.ActivateUserRequest
